  ...
  return (
    <div>
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="mt-5 mr-10 lg:mr-36 ml-10 lg:ml-36 mb-4 ">
        ...
        <div className=" ">
          <div className="stats shadow mt-10 flex lg:flex-row flex-col justify-center items-center">
            <div className="stat bg-base-300 hover:scale-95 flex flex-col justify-center items-center">
            ...
            <div className="stat bg-base-300 flex flex-col justify-center items-center hover:scale-95">
            ...
            <div className="stat bg-base-300 flex flex-col justify-center items-center hover:scale-95 p-8">
              {/* <div className="stat-figure text-secondary">

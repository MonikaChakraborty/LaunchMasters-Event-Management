...
const Culture = () => {
  return (
    <div className="mt-28 mb-24 flex shadow-lg pl-5">
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="flex flex-col items-center justify-center space-y-4 mr-3">
          <img className="w-[360px] rounded-lg" src={image1} alt="" />
          <div className="flex flex-col space-y-4">
            <img className="w-[369px] rounded-t-lg" src={image2} alt="" />
          </div>
        </div>

        {/* right sided */}
        <img className=" w-[280px] h-[460px] rounded-t-lg" src={image3} alt="" />
      </div>
    </div>
  );
};

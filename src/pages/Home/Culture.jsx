...
const Culture = () => {
  ...
  return (
    <div className="mt-16 lg:mt-24 mb-16 lg:mb-24 flex flex-col lg:flex-row shadow-lg pl-5 max-w-screen-xl mx-auto">
      <div className="lg:w-2/5 lg:mr-32" data-aos="fade-up">
        <h1 className="text-3xl lg:text-4xl font-semibold text-center mb-5 lg:mb-12 text-blue-700">
          Our Office Culture
        </h1>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center">
        {/* left sided */}
        <div className="flex flex-col items-center justify-center space-y-4 lg:mr-3">
